...
import { Task, useTaskFlow } from "@/hooks/useTaskFlow";
import { CreateTaskDialog } from "@/components/CreateTaskDialog";
import { TaskDetailDialog } from "@/components/TaskDetailDialog";

const getIssueTypeIcon = (type: Task['type']) => {
  switch (type) {
...
export default function Backlog() {
  ...
  const toggleSprintExpansion = (sprintId: number) => {
  ...
  return (
    <Layout showAnalytics={false}>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <Select value={filterType} onValueChange={(value) => setFilterType(value as Task['type'] | 'all')}>
